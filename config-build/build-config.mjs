...
const settingsRows = [
  ...
  [
    "DASHBOARD_URL",
    "https://bjpatel90.github.io/Operations-KPI-Command-Center/docs/",
...
const reportRows = [
  ...
  [
    ...
    "bhavesh.patel@mosaicwellness.in",
    'from:bhavesh.patel@mosaicwellness.in subject:"Inventory Adjustment Report |" -in:trash',
    "Inventory Adjustment Report |",
    "https://bjpatel90.github.io/inventory-adjustment-dashboard/",
    "METRIC_CARDS",
  ],
  [
    true,
...
const fieldRows = [
  ...
  [true, "inventory-adjustment", 2, "Added Qty", "Added Qty", "BEFORE_OR_AFTER", "positive", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 3, "Removed Qty", "Removed Qty", "BEFORE_OR_AFTER", "warning", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 4, "Net Variance", "Net Variance", "BEFORE_OR_AFTER", "positive", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 5, "Balanced SKUs", "Balanced SKUs", "BEFORE_OR_AFTER", "positive", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 6, "Variance SKUs", "Variance SKUs", "BEFORE_OR_AFTER", "warning", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 7, "Facilities", "Facilities", "BEFORE_OR_AFTER", "", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 8, "Users Impacted", "Users Impacted", "BEFORE_OR_AFTER", "", "FIXED", "Daily summary"],
  [true, "inventory-adjustment", 9, "MTD Events", "MTD Events", "BEFORE_OR_AFTER", "", "FIXED", "Month-to-date summary"],
  [true, "inventory-adjustment", 10, "MTD Added", "MTD Added", "BEFORE_OR_AFTER", "positive", "FIXED", "Month-to-date summary"],
  [true, "inventory-adjustment", 11, "MTD Removed", "MTD Removed", "BEFORE_OR_AFTER", "warning", "FIXED", "Month-to-date summary"],
  [true, "inventory-adjustment", 12, "MTD Variance", "MTD Variance", "BEFORE_OR_AFTER", "positive", "FIXED", "Month-to-date summary"],
